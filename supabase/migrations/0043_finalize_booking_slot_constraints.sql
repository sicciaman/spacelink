/*
  ...
  1. Changes
    ...
    - Create new partial unique index for active bookings
    - Update booking slots view
...
DROP CONSTRAINT IF EXISTS unique_channel_timeslot;
