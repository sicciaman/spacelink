...
export default function ExitBookingDialog({ isOpen, onClose, onConfirm }: Props) {
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        If you leave now, your selected time slot will be released and available for others to book. 
